...
common:
	...
	# a specific platform
	ADDON_INCLUDES_EXCLUDE = libs/tbb/include/%
...
osx:
	...
	ADDON_LIBS += libs/tbb/lib/osx/libtbbmalloc_debug.dylib
	ADDON_LIBS += libs/tbb/lib/osx/libtbbmalloc_proxy_debug.dylib
	
	#ADDON_LIBS = libs/tbb/lib/osx/libtbb_preview.dylib
